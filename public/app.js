  ...
  if (reportes.length === 0) {
    const datosPrueba = [
      ...
      },
      {
        ...
        diagnostico: null,
        requiere_reparacion: null,
        notas: 'Revisión del sistema eléctrico en proceso',
      ...
      },
      {
        ...
        diagnostico: null,
        requiere_reparacion: null,
        notas: 'Mantenimiento preventivo programado',
      ...
      },
      {
        ...
        requiere_reparacion: 1,
        notas: 'Reparación en proceso - día 2 de 3',
      ...
      },
      {
        ...
        notas: 'Vehículo operando correctamente. Seguimiento por 7 días.',
        fecha_reporte: new Date(Date.now() - 518400000).toISOString(),
        fecha_actualizacion: new Date().toISOString()
      }
    ];
    guardarReportes(datosPrueba);
    mostrarToast('✅ Datos de prueba cargados', 'success');
  }
}
